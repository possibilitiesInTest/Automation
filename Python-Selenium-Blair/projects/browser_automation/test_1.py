...
secrets_input = browser.find.element_by_css_selector("input[id='r2Input']")
secrets_answer_butn = browser.find.element_by_css_selector("button#r2Butn")

# Two Merchants
richest_merchant_name = browser.find_element_by_xpath("//[text()='3000']").text
